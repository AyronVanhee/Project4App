...
<script>
  ...
  let movies = [
    {
      MovieID: "bf1a024b-9229-4b34-a559-b4ae3a1b6004",
      ...
      Video:
        "http://student.howest.be/ayron.vanhee/Project4/Videos/theworldsend.mp4",
      Duration: 109,
      Price: 4,
      Genre: "Komedie",
      Year: 2013
    ...
    },
    {
      ...
      Name: "Road House",
      Description:
        "Road House is een film uit 1989 met Patrick Swayze in de hoofdrol. De film gaat over 'Dalton', een uitsmijter in een bar in Jasper (Missouri). De regie is van Rowdy Herrington. Na het enorme succes van Dirty Dancing (de doorbraakfilm van Patrick Swayze) viel het bezoekersaantal voor 'Road House' flink tegen. De critici waren ook niet erg enthousiast over de film, die sindsdien wel tot een cultfilm is uitgegroeid.",
      Image: "~/Images/roadHouse.jpg",
      Video:
        "http://student.howest.be/ayron.vanhee/Project4/Videos/roadhouse.mp4",
      Duration: 45,
      Price: 15,
      Genre: "Actie",
      Year: 1989
